...
class UpdateUserController:
    ...
    def __call__(self, request: IRequest) -> IResponse:
        try:
            ...
            user = self.UpdateUserUsecase(user_id=request.data.get('user_id'), new_name=new_name, new_email=new_email, new_cellphone=new_cellphone, new_address=new_address, new_cep=new_cep)
