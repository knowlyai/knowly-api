def send_email_presenter(event, context):
    ...
    if event['triggerSource'] == 'CustomMessage_SignUp' or event['triggerSource'] == "CustomMessage_ResendCode":
        ...
        * {{
        ...
        <div align="center">
        <p style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #00000; none;font-size: 30px;"><span style="display:block;padding:10px 20px;line-height:120%;"><strong>{##Verify Email##}</strong></span></p>
        </div>
        </td>
        </tr>
        </tbody>
